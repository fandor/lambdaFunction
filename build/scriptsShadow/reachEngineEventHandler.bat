...
set CLASSPATH=%APP_HOME%\lib\reachEngineEventHandler-0.1-all.jar

@rem Execute reachEngineEventHandler
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %REACH_ENGINE_EVENT_HANDLER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
